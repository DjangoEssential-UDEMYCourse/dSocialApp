...
SECRET_KEY = 'django-insecure-szs+h=nmh1b_n!g-=#n543-ftdprqa=#5dda2fmv3v0f3)1xt_'
...
AUTHENTICATION_BACKENDS = [
    ...
    # Apenas se quiser manter a authenticacao padrão do Django
